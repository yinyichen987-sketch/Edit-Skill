...
SECTION_START_IN_SONG = 124.33          # 第 66 小节（歌曲时间）
SECTION_BARS = 32                       # 32 小节
...
SHOTS = [
    ("0a550967",   6.800,  7, "连杀簇：2 杀 [6.8, 9.47]，跨度 2.67s"),
    ("38cc4903",   1.300,  5, "连杀簇：3 杀 [1.3, 2.23, 2.9]，跨度 1.6s"),
    ("4b0460c4",  14.733,  6, "连杀簇：2 杀 [14.73, 16.73]，跨度 2.0s"),
    ("4c58efb4",   1.433,  8, "连杀簇：3 杀 [1.43, 2.1, 4.67]，跨度 3.23s"),
    ("58b8e283",   4.000,  8, "连杀簇：2 杀 [4.0, 7.2]，跨度 3.2s"),
    ("6b2eea34",  10.100,  8, "连杀簇：2 杀 [10.1, 12.97]，跨度 2.87s"),
    ("7f0d8287",  18.067,  6, "连杀簇：2 杀 [18.07, 20.37]，跨度 2.3s"),
    ("b61cc53d",   6.200,  5, "连杀簇：2 杀 [6.2, 6.8]，跨度 0.6s"),
    ("dcc871b1",  14.533,  5, "连杀簇：2 杀 [14.53, 15.13]，跨度 0.6s"),
    ("0a550967",  18.300,  5, "连杀簇：2 杀 [18.3, 18.87]，跨度 0.57s"),
    ("38cc4903",   6.800,  6, "连杀簇：2 杀 [6.8, 8.73]，跨度 1.93s"),
    ("4c58efb4",   4.667,  7, "连杀簇：2 杀 [4.67, 7.33]，跨度 2.67s"),
    ("58b8e283",  20.900,  5, "连杀簇：2 杀 [20.9, 21.83]，跨度 0.93s"),
    ("7f0d8287",  38.433,  5, "连杀簇：2 杀 [38.43, 39.57]，跨度 1.13s"),
    ("b61cc53d",   9.567,  6, "连杀簇：3 杀 [9.57, 10.7, 11.77]，跨度 2.2s"),
    ("dcc871b1",  22.900,  5, "连杀簇：2 杀 [22.9, 23.5]，跨度 0.6s"),
    ("4c58efb4",  19.900,  5, "连杀簇：2 杀 [19.9, 20.77]，跨度 0.87s"),
    ("58b8e283",  26.600,  5, "连杀簇：2 杀 [26.6, 27.23]，跨度 0.63s"),
    ("b61cc53d",  19.100,  6, "连杀簇：2 杀 [19.1, 21.33]，跨度 2.23s"),
    ("b61cc53d",  22.700,  7, "连杀簇：2 杀 [22.7, 25.33]，跨度 2.63s"),
    ("6b2eea34",  22.833,  8, "连杀簇：2 杀 [22.83, 25.97]，跨度 3.13s"),
]
...
#    所以生成时打印命中数量，改完必须核对。
#   21 镜的起点拍号：0,7,12,18,26,34,42,48,53,58,63,69,76,81,86,92,97,102,107,113,120
TRANSITION_AT_BEAT = {12, 48, 86, 120}       # 第 3 / 9 / 12 镜起点
